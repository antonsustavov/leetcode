package com.sustav.ALGORITHM.challenges.leetcode.structure.hashtable;
...
public class HashTableSeparateList<K,V> implements Iterable<K> {
    ...
    public HashTableSeparateList() {
        this(DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR);
    }

    public HashTableSeparateList(int capacity) {
        this(capacity, DEFAULT_LOAD_FACTOR);
    }

    // Designated constructor
    public HashTableSeparateList(int capacity, double maxLoadFactor) {
